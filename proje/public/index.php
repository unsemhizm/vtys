...
<div class="login-modal-overlay" id="loginModal">
  <div class="login-container">
    ...
    <div id="errorBox" class="error-msg">Geçersiz kullanıcı adı veya şifre!</div>

    <div class="login-form-wrapper">
      <!-- STUDENT LOGIN FORM -->
      <form id="studentForm" class="login-form active" onsubmit="handleLogin(event, 'student')">
        <div class="input-group">
          <label>Öğrenci E-postası</label>
          <div class="input-wrapper">
            <span class="input-icon">📧</span>
            <input type="email" id="studentEmail" placeholder="ahmet.uzun@firat.edu.tr" required />
          </div>
        </div>
        ...
        <div class="input-group">
          ...
          <div class="input-wrapper">
            <span class="input-icon">🔒</span>
            <input type="password" id="studentPass" placeholder="••••••••" required />
          </div>
        </div>
        ...
        <div class="form-options">
          ...
          <a href="#" class="forgot-pass" onclick="alert('Şifre sıfırlama talebiniz öğrenci işlerine iletilmiştir.')">Şifremi Unuttum</a>
        </div>
      ...
      <!-- STAFF LOGIN FORM -->
      <form id="staffForm" class="login-form" onsubmit="handleLogin(event, 'staff')">
        <div class="input-group">
          <label>Personel E-postası</label>
          <div class="input-wrapper">
            <span class="input-icon">📧</span>
            <input type="email" id="staffEmail" placeholder="hakan.demir@firat.edu.tr" required />
          </div>
        </div>
        ...
        <div class="input-group">
          ...
          <div class="input-wrapper">
            <span class="input-icon">🔒</span>
            <input type="password" id="staffPass" placeholder="••••••••" required />
          </div>
        </div>
        ...
        <div class="form-options">
          ...
          <a href="#" class="forgot-pass" onclick="alert('Şifre sıfırlama talebiniz bilgi işleme iletilmiştir.')">Şifremi Unuttum</a>
        </div>
      ...
      <!-- ADMIN LOGIN FORM -->
      <form id="adminForm" class="login-form" onsubmit="handleLogin(event, 'admin')">
        <div class="input-group">
          <label>Yönetici E-postası</label>
          <div class="input-wrapper">
            <span class="input-icon">📧</span>
            <input type="email" id="adminEmail" placeholder="admin@firat.edu.tr" required />
          </div>
        </div>
